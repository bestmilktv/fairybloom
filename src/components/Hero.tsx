...
const Hero = () => {
  ...
  return <section ref={heroRef} className={`relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-secondary/30 to-accent/20 scroll-fade-in ${heroVisible ? 'visible' : ''}`}>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6 fade-in-up">
        <EditableText
          id="hero-title"
          text="Přírodní krása zachycená v čase"
          as="h2"
          className="text-5xl md:text-7xl font-serif font-bold text-luxury-foreground mb-6 tracking-wide"
        />
        
        <EditableText
          id="hero-subtitle"
          text="Objevte naši jedinečnou kolekci šperků s opravdovými květinami z českých luk a lesů. Každý kousek je vytvořen ručně s láskou k detailu a nese v sobě kouzlo přírody."
          as="p"
          className="text-xl md:text-2xl text-luxury-foreground/90 mb-8 leading-relaxed max-w-2xl mx-auto"
          multiline
        />
